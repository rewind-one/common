...
public class BrowserMobProxyServer implements BrowserMobProxy {
	...
	// TODO
	public void replaceLastHttpFilter(ResponseFilter filter) {
		filterFactories.remove(filterFactories.size() -1 );
		filterFactories.add(new ResponseFilterAdapter.FilterSource(filter));
	}

	// TODO
	public void replaceFirstHttpFilter(RequestFilter filter) {
		filterFactories.remove(0);
		filterFactories.add(0, new RequestFilterAdapter.FilterSource(filter));
	}
